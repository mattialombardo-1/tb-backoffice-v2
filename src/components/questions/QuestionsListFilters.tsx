...
import type { DifficultyLevel, QuestionLanguage, QuestionStatus, QuestionType } from '@/lib/types/questions';
  ...
  return (
    ...
    <div className="flex items-center gap-3 flex-wrap">
      ...
      <MultiSelect
        ...
        placeholder={authors.isLoading ? t('questions.filters.loadingAuthors') : t('questions.filters.author')}
      ...
      <div className="flex items-center gap-1">
        ...
        <Button
          ...
          title={filters.collectionIdsMode === 'exclude' ? 'NON in queste collection — clicca per invertire' : 'IN queste collection — clicca per invertire'}
        >
      ...
      <div className="flex items-center gap-1">
        ...
        <Button
          ...
          title={filters.poolIdsMode === 'exclude' ? 'NON in questi pool — clicca per invertire' : 'IN questi pool — clicca per invertire'}
        >
      ...
      {hasAnyFilter && (
        <Button variant="ghost" size="sm" onClick={onReset} aria-label={t('questions.filters.resetAll')}>
